...
prop_mod <- lmerTest::lmer(Speech_Prop ~ Study + Study:Diagnosis + (1|ID), data = scaled_data, control = lmerControl(optimizer = "nloptwrap", calc.derivs = FALSE,  optCtrl = list(ftol_abs = 1e-10, xtol_abs = 1e-10, maxeval=10000)))
